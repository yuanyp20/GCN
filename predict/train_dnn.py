...
if __name__ == "__main__":
    ...
    save_path = './train_5/save_path/time_%d' % times + '.pth'
    writer = SummaryWriter('./train_5/writer/time_%d' % times)
    ...
    predict_result.to_csv('./train_5/result.csv', mode='a', index=None, header=None)
