...
if __name__ == "__main__":
    ...
    save_path = './train_2/save_path/time_%d' % times + '.pth'
    writer = SummaryWriter('./train_2/writer/time_%d' % times)
    ...
    predict_result.to_csv('./train_2/result.csv', mode='a', index=None, header=None)
