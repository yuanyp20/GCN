...
print(net)
net.to(device)
criterion = MultiFocalLoss(num_class=3)
# criterion = facal
...
if __name__ == "__main__":
    ...
    save_path = './train_4/save_path/time_%d' % times + '.pth'
    writer = SummaryWriter('./train_4/writer/time_%d' % times)
    ...
    predict_result.to_csv('./train_4/result.csv', mode='a', index=None, header=None)
    ...
    compare_result.to_csv('./train_4/compare/time_%d' % times + '.csv', mode='w', index=0, header=None)
