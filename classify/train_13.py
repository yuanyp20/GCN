...
if __name__ == "__main__":
    ...
    save_path = './train_13/save_path/time_%d' % times + '.pth'
    writer = SummaryWriter('./train_13/writer/time_%d' % times)
    ...
    predict_result.to_csv('./train_13/result.csv', mode='a', index=None, header=None)
    ...
    compare_result.to_csv('./train_13/compare/time_%d' % times + '.csv', mode='w', index=0, header=None)
