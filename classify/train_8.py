...
if __name__ == "__main__":
    ...
    save_path = './train_8/save_path/time_%d' % times + '.pth'
    writer = SummaryWriter('./train_8/writer/time_%d' % times)
    ...
    predict_result.to_csv('./train_8/result.csv', mode='a', index=None, header=None)
    ...
    compare_result.to_csv('./train_8/compare/time_%d' % times + '.csv', mode='w', index=0, header=None)
